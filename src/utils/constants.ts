...
export class Constants {
  ...
  public static SUFIX_CPU_GOVERNOR = ".cpu.governor";
  ...
  public static DEFAULT_MODE =
    Constants.PREFIX_PROFILES + Constants.DEFAULT_ID + Constants.SUFIX_MODE;
  public static DEFAULT_SPL =
    Constants.PREFIX_PROFILES + Constants.DEFAULT_ID + Constants.SUFIX_SPL;
  public static DEFAULT_SPPL =
    Constants.PREFIX_PROFILES + Constants.DEFAULT_ID + Constants.SUFIX_SPPL;
  public static DEFAULT_FPPL =
    Constants.PREFIX_PROFILES + Constants.DEFAULT_ID + Constants.SUFIX_FPPL;
  public static DEFAULT_CPU_BOOST =
    Constants.PREFIX_PROFILES +
    Constants.DEFAULT_ID +
    Constants.SUFIX_CPU_BOOST;
  public static DEFAULT_CPU_SMT =
    Constants.PREFIX_PROFILES + Constants.DEFAULT_ID + Constants.SUFIX_CPU_SMT;

  public static PREFIX_SETTINGS = "settings.";
  public static BATTERY_LIMIT = Constants.PREFIX_SETTINGS + "limit_battery";
  public static PROFILE_PER_GAME =
    Constants.PREFIX_SETTINGS + "profile_per_game";
